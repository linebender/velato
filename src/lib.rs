...
//! Render a Lottie animation to any type that implements the [PaintScene](https://docs.rs/anyrender/latest/anyrender/trait.PaintScene.html)
//! trait from the [`anyrender`](https://github.com/DioxusLabs/anyrender) crate. There are implementations available for `vello`, `vello_cpu`,
//! `vello_hybrid`, and `skia_safe`, or you can implement the trait yourself.
//!
//! ## Usage
//!
//! ```no_run
...
//! let alpha = 1.0;
//! let scene = renderer.render(&composition, frame, transform, alpha, &mut painter);
//! ```
//!
